...
export default function AboutUs() {
  return (
    <div className="my-20 w-full mx-auto flex flex-col items-center justify-center sm:gap-5 gap-2 relative overflow-hidden">
      ...
      <Image
        ...
        width={250}
        height={65}
        className="mx-auto sm:w-[250px] w-[200px]"
      />

      <div className="text-[#A426FF] sm:text-xl text-lg font-bold">
        TESTIMONIALS
      </div>
